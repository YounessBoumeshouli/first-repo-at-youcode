...
printf("Si vous pouvez Quitter entrez autre 0\n");
scanf("%d",&choix);
x=choix;
switch (choix)
{
...
void supprimer(){
    ...
    for (int i = 0; i < contact_numero; i++)
    {
       ...
       {
        for (int j = i; j < contact_numero-1; j++)
        {
...
void coupieStruct(contactes *cont, contactes *contact){
